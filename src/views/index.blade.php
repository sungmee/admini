...
<div class="my-3 p-3 bg-white rounded shadow-sm">
    ...
    <div class="media text-muted pt-3" id="item-{{ $item->post_id }}">
        ...
        <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <strong class="d-block text-gray-dark"><a href="{{ route('page', ['slug' => $item->slug]) }}" title="{{ trans('admini::post.index.view') }}" target="_blank">{{ $item->title ?? Str::title($item->slug) }}</a></strong>
